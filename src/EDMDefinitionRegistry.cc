...
std::string_view EDMDefinitionRegistry::getDefinition(std::string_view edm_name) const {
  const auto it = std::find_if(m_definitions.cbegin(), m_definitions.cend(),
...
std::string_view EDMDefinitionRegistry::getDefinition(size_t index) const {
