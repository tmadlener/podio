...
namespace detail {
  // Information about the collection class type, whether it is a subset
  // collection and the index in the collection branches cache vector
  using CollectionInfo = std::tuple<std::string, bool, size_t>;
} // namespace detail
