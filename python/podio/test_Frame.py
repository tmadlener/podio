...
EXPCTED_EXTENSION_COLL_NAMES = {"extension_Contained", "extension_ExternalComponent", "extension_ExternalRelation"}
...
class FrameReadTest(unittest.TestCase):
  ...
  def test_frame_collections(self):
    ...
    self.assertEqual(set(self.other_event.collections), EXPECTED_COLL_NAMES.union(EXPCTED_EXTENSION_COLL_NAMES))
